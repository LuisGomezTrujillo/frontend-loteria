...
import { FaTv, FaClipboardList, FaTicketAlt, FaTrophy, FaVial, FaFlask } from 'react-icons/fa';
...
const NavMenu = () => (
  <nav style={{
    ...
    <Link to="/admin/presorteos" title="PRE-SORTEOS (PRUEBAS)" style={{color:'white'}}>
      <FaFlask size={24} />
    </Link>
